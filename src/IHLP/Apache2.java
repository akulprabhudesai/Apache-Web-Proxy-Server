...
public class Apache2 {
    ...
    public int run(int X) throws IOException {   /* you can define the signature for run() */
        ...
        try {
            ...
            System.out.println("server ip is " + server.getInetAddress().getHostAddress());
            int clientCounter = 0;
            while (true) {
                System.gc();
                PREFERRED=null;
